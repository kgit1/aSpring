...
public class SpitterDaoNamedParameterJdbcTemplate implements SpitterDao {
	...
	private static final String SQL_UPDATE_SPITTER = "update spitter set username = :username, "
			+ "password = :password, fullname = :fullname " + "where id = ?";
	...
	public Spitter getSpitterById(long id) {
		...
		jdbcTemplate.queryForObject(SQL_SELECT_SPITTER_BY_ID, new ParameterizedRowMapper<Spitter>() {
	...
	public void saveSpitter(Spitter spitter) {
		jdbcTemplate.update(SQL_UPDATE_SPITTER, spitter.getUsername(), spitter.getPassword(), spitter.getFullName(),
				spitter.getId());
	}
